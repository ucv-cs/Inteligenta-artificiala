/**
 * L02. Cautare in adancime
 * Implementati algoritmul de cautare in adancime (adaugarea se face la început
 * in lista noduri spre deosebire de cautarea in latime).
 */
#include <iomanip>
#include <iostream>
using namespace std;
