/**
 L04. Timpi de deplasare pentru cautarile in latime, adancime si cost uniform
 Stiind ca ne deplasam in medie cu 80 km/h si folsind numarul de km intre orase,
 scrieti un program care sa calculeze timpul de deplasare pe ruta gasita pentru
 fiecare din cautarile in latime, adancime si cost uniform.
*/
#include <iomanip>
#include <iostream>
using namespace std;
